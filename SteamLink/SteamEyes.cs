...
public class SteamEyes
{
    ...
    [OSCMap("/sl/xrfb/facew/InnerBrowRaiserR")] // This particular parameter seems to be both for eyebrows *and* for eye widening.
    public float RightEyeLidExpandedSqueeze
    {
        set
        {
            EyeRight.ExpandedSqueeze = value;
            EyeCombined.ExpandedSqueeze = MathX.Average(value, EyeLeft.ExpandedSqueeze);
        }
    }
    ...
    [OSCMap("/sl/xrfb/facew/InnerBrowRaiserL")] // The left one is also for both eye widening and eyebrow raising.
    public float LeftEyeLidExpandedSqueeze
    {
        set
        {
            EyeLeft.ExpandedSqueeze = value;
            EyeCombined.ExpandedSqueeze = MathX.Average(value, EyeRight.ExpandedSqueeze);
        }
    }
